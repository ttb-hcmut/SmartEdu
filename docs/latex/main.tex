...
\begin{center}
    {\LARGE \textbf{Report: Specialized Project (CO4029)}} \\[1.0cm]
...
{\LARGE \textbf{Research and Development a smart query solution}\\[0.5cm] }
{\LARGE \textbf{using Knowledge Graphs and Language Models.}\\[2.0cm] }
...
\begin{table}[h]
\begin{tabular}{rll}
\hspace{6 cm} &  \textbf{\Large Committee:} {\Large HĐ 3CC Đồ án chuyên ngành}
\\
\\
\hspace{6 cm} &   \textbf{\Large Instructor:} {\Large Assoc. Prof. Thoại Nam}
\\
\\
\hspace{6 cm}  &   \textbf{\Large Secretary:} {\Large Mr. Lê Đình Thuận}
\\
\\
...
\newpage
\input{Contents/06_Experiments.tex}
\newpage
\input{Contents/07_Eval.tex}
\newpage
%%%%%%%%%%%%%%%%%OUTRO%%%%%%%%%%%%%%%%%%%
