...
\end{tikzpicture}
\vspace{10pt}
\caption{Teaching sub-graph flow detailing deterministic content lookup, RAG fallback pathways, active instruction delivery, and adaptive topic progression.}
\label{fig:teach_wf}
\end{figure}