...
\begin{tikzpicture}[
  ...
  box/.style={draw, rounded corners=3pt, minimum height=0.6cm, align=center, font=\small, fill=#1},
  db/.style={cylinder, draw, shape border rotate=90, minimum width=1.6cm, minimum height=0.7cm, font=\small, fill=#1, aspect=0.25},
